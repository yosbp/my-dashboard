...
function toggleSettingsDrawer(value) {
    showSettingsDrawer.value = value;
}
function toggleNavbarPosition(value) {
    navbarFixed.value = value;
}
function updateSidebarTheme(value) {
...
const layoutClass = computed(() => useRoute().meta.layoutClass);
